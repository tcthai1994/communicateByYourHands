                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            <form action="CenterServlet" onsubmit="return validateDictionary()" method="POST" name="myForm" class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="txtKeyword" id="form-field-1" placeholder="Key word" class="col-xs-10 col-sm-4" required/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="txtDescription" id="form-field-2" placeholder="Description" class="col-xs-10 col-sm-10" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="txtVideoURL" id="form-field-3" placeholder="Video URL" class="col-xs-10 col-sm-6" required/>
                                                    </div>
                                                </div>
