 ...
 * @author Thai
 */
public class GetDataForMobileDAO {

    public GetDataForMobileDAO(EntityManagerFactory emf) {
        this.emf = emf;
    }
