...
import myo.fpt.sample.entity.model.download.GetDataForMobileDAO;
...
@Path("DownloadAPI")
public class GetDataForMobileService {
    ...
    private GetDataForMobileDAO getJpaController() {
        try {
            return new GetDataForMobileDAO(getEntityManagerFactory());
        } catch (NamingException ex) {
            throw new RuntimeException(ex);
        }
    }

    public GetDataForMobileService() {
    }
