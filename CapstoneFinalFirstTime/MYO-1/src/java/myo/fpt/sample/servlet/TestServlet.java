...
public class TestServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            String test = request.getParameter("testchoi");
            int a = Integer.parseInt(test);
            Account tmp = getJpaController().findAccount(a);
            System.out.println(tmp.getUsername());
            System.out.println("Tao dang test servlet");
    ...
    private AccountDAO getJpaController() {
        try {
            return new AccountDAO(getEntityManagerFactory());
