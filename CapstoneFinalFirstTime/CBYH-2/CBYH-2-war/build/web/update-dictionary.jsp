        ...
        <script>
                    function validateUpdateDictionary(){
                        ...
                        if(keyword.length > 20){
                            errorContent += "Key word must be 1 - 20 characters";
                        }
                        if(description.length > 250 || description.length < 5){
                            errorContent += "Description must be 5 - 250 characters";
                        }
                        if(videoURL.length > 255){
                            errorContent += "Video URL must be 1 - 255 characters";
                        }
                        if(errorContent !== ""){
                            alert(errorContent);
                            return false;
                                            ...
                                            <form action="DictionaryProcessServlet" onsubmit="return validateUpdateDictionary()" method="POST" name="myForm" class="form-horizontal">
                                                <c:set var="status" value='<%= request.getParameter("chbStatus")%>'></c:set>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input readonly="" name="txtInstructionId" type="text" class="col-xs-10 col-sm-1" id="form-input-readonly" value="<%= request.getParameter("txtInstructionId")%>" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="txtKeyword" value="<%= request.getParameter("txtKeyword")%>" id="form-field-1" placeholder="Key word" class="col-xs-10 col-sm-3" required/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="txtDescription" value="<%= request.getParameter("txtDescription")%>" id="form-field-2" placeholder="Description" class="col-xs-10 col-sm-10" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="txtVideoURL" value="<%= request.getParameter("txtVideoURL")%>" id="form-field-3" placeholder="Video URL" class="col-xs-10 col-sm-6" required/>
                                                    </div>
                                                </div>
                                                <div class="form-group">
