...
public class CustomSignalPK implements Serializable {
    ...
    @Column(name = "customLeft", nullable = false)
    private int customLeft;
    @Basic(optional = false)
    @Column(name = "customRigh", nullable = false)
    ...
    public String toString() {
        return "fpt.myo.entityBean.CustomSignalPK[ customLeft=" + customLeft + ", customRigh=" + customRigh + " ]";
    }
