<%-- 
    Document   : addLicense
    Created on : Mar 10, 2016, 5:22:33 AM
    Author     : AnhND
--%>
                            ...
                            <div class="page-content-area">                      
                                <div class="page-content-area">                      
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <!-- PAGE CONTENT BEGINS -->
                                            <form action="LicenseProcessServlet" onsubmit="return validateLicense()" method="POST" name="myForm" class="form-horizontal">

                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> License Name (*) </label>

                                                    <div class="col-sm-9">
                                                        <input type="text" name="txtLicensename" id="form-field-1" placeholder="License Name" class="col-xs-10 col-sm-4" required/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="txtPrice" id="form-field-2" placeholder="Price" class="col-xs-10 col-sm-2" required/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="txtDescription" id="form-field-3" placeholder="Description" class="col-xs-10 col-sm-10" required/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label>
                                                        <input name="chbStatus" class="ace ace-switch ace-switch-6" type="checkbox" id="checkstatus" value="ON"/>
                                                        <span class="lbl" ></span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="clearfix form-actions">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        <button class="btn btn-info" type="submit" value="AddLicense" name="btAction">
