<%-- 
    Document   : update-license
    Created on : Mar 10, 2016, 5:27:22 AM
    Author     : AnhND
--%>
    ...
    <head>
        ...
        <script>
            function validateUpdateLicense() {
                var licenseName = document.forms["myForm"]["txtLicensename"].value;
                var price = document.forms["myForm"]["txtPrice"].value;
                var description = document.forms["myForm"]["txtDescription"].value;
                var errorContent = "";
                if (licenseName.length > 20 || licenseName.length < 5) {
                    errorContent += "License name must be 5 - 20 characters";
                }
                if (isNaN(price)) {
                    errorContent += "Price must be numbers";
                }
                if (price < 0 || price > 50) {
                    errorContent += "Price must be 0 - 50 (unit: 1000VND)";
                }
                if (description.length > 250 || description.length < 6) {
                    errorContent += "Description must be 6 - 250 characters";
                }
                if (errorContent !== "") {
                    alert(errorContent);
                    return false;
                            ...
                            <div class="page-content-area">                      
                                <div class="page-content-area">                      
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <!-- PAGE CONTENT BEGINS -->
                                            <form action="LicenseProcessServlet" onsubmit="return validateUpdateLicense()" method="POST" name="myForm" class="form-horizontal">
                                                <c:set var="status" value='<%= request.getParameter("chbStatus")%>'></c:set>
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label no-padding-right" for="form-input-readonly"> License ID </label>

                                                        <div class="col-sm-9">
                                                            <input readonly="" name="txtLicenseId" type="text" class="col-xs-10 col-sm-1" id="form-input-readonly" value="<%= request.getParameter("txtLicenseId")%>" />
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> License Name (*) </label>

                                                    <div class="col-sm-9">
                                                        <input type="text" name="txtLicensename" value="<%= request.getParameter("txtLicensename")%>" id="form-field-1" placeholder="License name" class="col-xs-10 col-sm-3" required/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="txtPrice" value="<%= request.getParameter("txtPrice")%>" id="form-field-2" placeholder="Price" class="col-xs-10 col-sm-1" required/>
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-3"> Description (*)</label>

                                                    <div class="col-sm-9">
                                                        <input type="text" name="txtDescription" value="<%= request.getParameter("txtDescription")%>" id="form-field-3" placeholder="Description" class="col-xs-10 col-sm-10" required/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="clearfix form-actions">
                                                        <div class="col-md-offset-3 col-md-9">
                                                            <button class="btn btn-info" type="submit" value="UpdateLicense" name="btAction">
