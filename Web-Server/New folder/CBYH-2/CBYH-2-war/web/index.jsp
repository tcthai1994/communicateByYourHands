        ...
        <script>
            function validateRegister() {
                ...
                if (username.length > 20 || username.length < 6) {
                    errorContent += "Username must be 6 - 20 characters \n";
                }
                                ...
                                <div id="forgot-box" class="forgot-box widget-box no-border">
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            Click<a href="GCMTest.jsp">here</a>to come GCM test page
                                        </div><!-- /.widget-main -->
                                ...
                                <div id="signup-box" class="signup-box widget-box no-border">
                                    <div class="widget-body">
                                        <div class="widget-main">
                                            ...
                                            <form action="CenterServlet" onsubmit="return validateRegister()" method="POST" name="myForm">
                                                <fieldset>
                                                    <span>
                                                        Email:(*)
                                                    </span>
                                                    ...
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right fullname">
                                                    ...
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right username">
                                                            <input type="text" name="txtUsername" onkeyup="locdau(this);" runat="server" class="form-control" placeholder="" required/>
                                                            <i class="ace-icon fa fa-user"></i>
                                                        </span>
                                                    </label>
                                                    <span>
                                                    ...
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right phone">
