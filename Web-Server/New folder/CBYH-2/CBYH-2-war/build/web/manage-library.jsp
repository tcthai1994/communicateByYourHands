                                                                ...
                                                                <table id="results" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dynamic-table_info">
                                                                    <thead>
                                                                        <tr role="row">
                                                                            ...
                                                                            <th class="sorting_disabled" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1">Library Name</th>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="action-buttons">
                                                                                            <form method="POST" action="update-library.jsp" class="blue">
                                                                                                <input type="hidden" name="txtLibraryId" value="${items.libraryId}" />
                                                                                            <input type="hidden" name="txtLibraryname" value="${items.libraryName}"/>
