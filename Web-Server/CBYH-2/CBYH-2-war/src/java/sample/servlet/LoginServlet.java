...
public class LoginServlet extends HttpServlet {
    ...
    private final String DictionaryPage = "dictionary.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (result) {
                ...
                List<Notification> notifications = notificationSessionBeanRemote.findNewNotifications(account.getCustId());
