<%-- 
    Document   : homePage
    Created on : Feb 18, 2016, 2:09:57 PM
    Author     : AnhND
--%>
                                                        ...
                                                        <table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dynamic-table_info">
                                                            <thead>
                                                                <tr role="row">
                                                                    ...
                                                                    <th class="sorting" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1">User Name</th>
                                                                    <th class="sorting" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1">Email</th>
                                                                    <th class="hidden-480 sorting" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1">Full Name</th>
                                                                    <th class="sorting" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1">Type of License</th>
                                                                    ...
                                                                    <th class="sorting" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1">is Staff</th>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <td>
                                                                                <div class="action-buttons">
                                                                                    <a class="blue" id="Btn" href="update-user.jsp?txtDetailId=${items.detailId}&txtUsername=${items.username}&txtEmail=${items.email}&txtFullname=${items.fullname}&txtPhone=${items.phone}&txtLicenseType=${items.licenseType}&dtExpiredDate=${items.expiredDate}&chbStatus=${items.status}&chbIsStaff=${items.isStaff}&btAction=Update">
