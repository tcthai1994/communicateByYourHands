<%-- 
    ...
    Created on : Mar 5, 2016, 12:58:07 AM
    Author     : AnhND
--%>
                        ...
                        <div class="page-content-area">                      
                            <div class="page-content-area">                      
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <!-- PAGE CONTENT BEGINS -->
                                        <form action="DictionaryProcessServlet" onsubmit="return validateDictionary()" method="GET" name="myForm" class="form-horizontal">

                                            <div class="form-group">
                                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Key Word (*) </label>

                                                <div class="col-sm-9">
                                                    <input type="text" name="txtKeyword" id="form-field-1" placeholder="Key word" class="col-xs-10 col-sm-5" required/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="txtDescription" id="form-field-2" placeholder="Description" class="col-xs-10 col-sm-5" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="txtVideoURL" id="form-field-3" placeholder="Video URL" class="col-xs-10 col-sm-5" required/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label>
                                                    <input name="chbStatus" value="ON" class="ace ace-switch ace-switch-6" type="checkbox" id="checkstatus"/>
                                                    <span class="lbl" ></span>
                                                </label>
                                            </div>
                                            ...
                                            <div class="clearfix form-actions">
                                                <div class="col-md-offset-3 col-md-9">
                                                    <button class="btn btn-info" type="submit" value="AddDictionary" name="btAction">
