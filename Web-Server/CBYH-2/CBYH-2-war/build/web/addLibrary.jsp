<%-- 
    Document   : addLibrary
    Created on : Mar 2, 2016, 8:24:15 PM
    Author     : AnhND
--%>
                        ...
                        <div class="page-content-area">                      
                            <div class="page-content-area">                      
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <!-- PAGE CONTENT BEGINS -->
                                        <form action="LibraryProcessServlet" onsubmit="return validateLibrary()" method="GET" name="myForm" class="form-horizontal">

                                            <div class="form-group">
                                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Library Name (*) </label>

                                                <div class="col-sm-9">
                                                    <input type="text" name="txtLibraryname" id="form-field-1" placeholder="Library Name" class="col-xs-10 col-sm-5" required/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="clearfix form-actions">
                                                <div class="col-md-offset-3 col-md-9">
                                                    <button class="btn btn-info" type="submit" value="AddLibrary" name="btAction">
