<%-- 
    Document   : update-dic
    Created on : Mar 5, 2016, 1:57:03 AM
    Author     : AnhND
--%>
...
<html>
    <head>
        ...
        <![endif]-->
        <script>
            function validateUpdateDictionary(){
                var keyword = document.forms["myForm"]["txtKeyword"].value;
                var description = document.forms["myForm"]["txtDescription"].value;
                var videoURL = document.forms["myForm"]["txtVideoURL"].value;
                if(keyword.length > 20){
                    alert("Key word must be 1 - 20 characters");
                    return false;
                }
                else if(description.length > 250 || description.length < 5){
                    alert("Description must be 5 - 250 characters");
                    return false;
                }
                else if(videoURL.length > 255){
                    alert("Video URL must be 1 - 255 characters");
                    return false;
                }
            }
        </script>
                        ...
                        <div class="page-content-area">                      
                            <div class="page-content-area">                      
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <!-- PAGE CONTENT BEGINS -->
                                        <form action="DictionaryProcessServlet" onsubmit="return validateUpdateDictionary()" method="GET" name="myForm" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input readonly="" name="txtInstructionId" type="text" class="col-xs-10 col-sm-5" id="form-input-readonly" value="<%= request.getParameter("txtInstructionId")%>" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="txtKeyword" value="<%= request.getParameter("txtKeyword")%>" id="form-field-1" placeholder="Key word" class="col-xs-10 col-sm-5" required/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="txtDescription" value="<%= request.getParameter("txtDescription")%>" id="form-field-2" placeholder="Description" class="col-xs-10 col-sm-5" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label no-padding-right" for="form-field-3"> Video URL (*) </label>

                                                <div class="col-sm-9">
                                                    <input type="text" name="txtVideoURL" value="<%= request.getParameter("txtVideoURL")%>" id="form-field-3" placeholder="Video URL" class="col-xs-10 col-sm-5" required/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="clearfix form-actions">
                                                <div class="col-md-offset-3 col-md-9">
                                                    <button class="btn btn-info" type="submit" value="UpdateDictionary" name="btAction">
