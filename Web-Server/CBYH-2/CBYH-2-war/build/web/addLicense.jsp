                        ...
                        <div class="page-content-area">                      
                            <div class="page-content-area">                      
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <!-- PAGE CONTENT BEGINS -->
                                        <form action="LicenseProcessServlet" onsubmit="return validateLicense()" method="GET" name="myForm" class="form-horizontal">

                                            <div class="form-group">
                                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> License Name (*) </label>

                                                <div class="col-sm-9">
                                                    <input type="text" name="txtLicensename" id="form-field-1" placeholder="License Name" class="col-xs-10 col-sm-5" required/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="txtPrice" id="form-field-2" placeholder="Price" class="col-xs-10 col-sm-5" required/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="txtDescription" id="form-field-3" placeholder="Description" class="col-xs-10 col-sm-5" required/>
                                                </div>
                                            </div>
