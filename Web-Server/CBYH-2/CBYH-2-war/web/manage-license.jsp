<%-- 
    Document   : manage-license
    Created on : Mar 10, 2016, 5:09:50 AM
    Author     : AnhND
--%>
                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            <div>
                                                <div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-6">
                                                            ...
                                                            <div id="dynamic-table_filter" class="dataTables_filter">
                                                                <a href="addLicense.jsp?btAction=Add" class="dt-button buttons-collection buttons-colvis btn btn-white btn-primary btn-bold" tabindex="0" aria-controls="dynamic-table" data-original-title="" title="">
                                                                    <span>
                                                    ...
                                                    <c:set var="info" value="${requestScope.LICINFO}"/>
                                                        ...
                                                        <table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dynamic-table_info">
                                                            <thead>
                                                                <tr role="row">
                                                                    ...
                                                                    <th class="sorting" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1">License Name</th>
                                                                    <th class="sorting" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1">Price</th>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <td>
                                                                                <div class="action-buttons">
                                                                                    ...
                                                                                    <a class="blue" id="Btn" href="update-license.jsp?txtLicenseId=${items.licenseId}&txtLicensename=${items.licenseName}&txtPrice=${items.price}&txtDescription=${items.description}&chbStatus=${items.status}&btAction=Update">
                                                                                    <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                                                </a>
                                                                                <c:url var="DelLic" value="LicenseProcessServlet">
                                                                                    <c:param name="btAction" value="DeleteLicense"/>
                                                                                    <c:param name="txtLicenseId" value="${items.licenseId}"/>
                                                                                </c:url>
                                                                                <a class="red" href="${DelLic}">
