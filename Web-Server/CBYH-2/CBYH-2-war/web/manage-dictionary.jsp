                                                        ...
                                                        <table id="dynamic-table" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dynamic-table_info">
                                                            <thead>
                                                                <tr role="row">
                                                                    ...
                                                                    <th class="sorting" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1">Key words</th>
                                                                    <th class="sorting" tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1">Video URL</th>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <td>
                                                                                <div class="action-buttons">
                                                                                    ...
                                                                                    <a class="blue" id="Btn" href="update-dictionary.jsp?txtInstructionId=${items.instructionId}&txtKeyword=${items.keyword}&txtDescription=${items.description}&txtVideoURL=${items.videoURL}&chbStatus=${items.status}&btAction=Update">
