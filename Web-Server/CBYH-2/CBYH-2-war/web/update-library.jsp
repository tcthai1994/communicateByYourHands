                        ...
                        <div class="page-content-area">                      
                            <div class="page-content-area">                      
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <!-- PAGE CONTENT BEGINS -->
                                        <form action="LibraryProcessServlet" onsubmit="return validateUpdateLibrary()" method="GET" name="myForm" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input readonly="" name="txtLibraryId" type="text" class="col-xs-10 col-sm-5" id="form-input-readonly" value="<%= request.getParameter("txtLibraryId")%>" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="txtLibraryname" value="<%= request.getParameter("txtLibraryname")%>" id="form-field-1" placeholder="Library name" class="col-xs-10 col-sm-5" required/>
                                                </div>
                                            </div>
