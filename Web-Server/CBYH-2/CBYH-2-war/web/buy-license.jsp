                                                    ...
                                                    <div class="col-xs-8 col-sm-9 pricing-span-body">
                                                        ...
                                                        <div class="pricing-span">
                                                            <div class="widget-box pricing-box-small widget-color-orange">
                                                                <div class="widget-header">
                                                                    <h5 class="widget-title bigger lighter">Premium</h5>
                                                                </div>
                                                                ...
                                                                <div class="widget-body">
                                                                    ...
                                                                    <div>
                                                                        <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" target="_top">
                                                                            ...
                                                                            <input type="hidden" name="return" value="http://localhost:8080/CBYH-2-war/PaymentWithPaypalServlet">
                                                                            <input type="hidden" name="cancel_return" value="http://localhost:8080/CBYH-2-war/payment-fail.jsp">
