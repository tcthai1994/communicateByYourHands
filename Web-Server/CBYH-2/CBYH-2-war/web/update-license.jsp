        ...
        <script>
            function validateUpdateLicense(){
                ...
                if(licenseName.length > 20 || licenseName.length < 6){
                    alert("License name must be 6 - 20 characters");
                    return false;
                }
                else if(isNaN(price)){
                    ...
                    alert("Price must be 0 - 50 (unit: 1000VND)");
                    return false;
                }
                else if(description.length > 250 || description.length < 6){
                    alert("Description must be 6 - 250 characters");
                    return false;
                }
            }
        </script>
                        ...
                        <div class="page-content-area">                      
                            <div class="page-content-area">                      
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <!-- PAGE CONTENT BEGINS -->
                                        <form action="LibraryProcessServlet" onsubmit="return validateUpdateLicense()" method="GET" name="myForm" class="form-horizontal">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input readonly="" name="txtLicenseId" type="text" class="col-xs-10 col-sm-5" id="form-input-readonly" value="<%= request.getParameter("txtLicenseId")%>" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="txtLicensename" value="<%= request.getParameter("txtLicensename")%>" id="form-field-1" placeholder="License name" class="col-xs-10 col-sm-5" required/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="txtPrice" value="<%= request.getParameter("txtPrice")%>" id="form-field-2" placeholder="Price" class="col-xs-10 col-sm-5" required/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" name="txtDescription" value="<%= request.getParameter("txtDescription")%>" id="form-field-3" placeholder="Description" class="col-xs-10 col-sm-5" required/>
                                                </div>
                                            </div>
